...
<div id="main" style="max-width: 900px; background: #f3f3f3; border: 1px solid #ddd; margin-top: 2rem">
    <div id="header">
        <h1 id="heading_title" style="margin-top:0">
            ICN Academy - About / Options
        </h1>
    </div>


    <p>ICN Academy was designed and developed to be one of the easiest and most hassle free quiz builders for WordPress. If
        you
        have any questions, or need support, please contact me at the <a href="https://wordpress.org/support/plugin/hd-quiz" target="_blank">official WordPress ICN Academy support
            forum</a>.</p>

    <p>As I continue to develop ICN Academy, more features, options, customizations, and settings will be introduced. If you
        have enjoyed ICN Academy, then I would sure appreciate it if you could <a href="https://wordpress.org/support/plugin/hd-quiz/reviews/#new-post" target="_blank">leave an honest
    ...
    <div class="hdq_highlight" id="hd_patreon">
        ...
        <p>
            ICN Academy is a 100% free plugin developed in my spare time, and as such, I get paid in nothing but good will
            and positive reviews. If you are enjoying ICN Academy and would like to show your support, please consider
    ...
    <p>I am developing ICN Academy in my spare time, but still plan to add the following features at some point</p>
    <ul class="hdq_list">
        ...
        <li>Global / default quiz options <span class="hdq_tooltip hdq_tooltip_question">?<span class="hdq_tooltip_content"><span>These would become the default for all quizzes, but could be
    ...
    <center>
        ...
        <p>
            <small>watch a full tutorial on how to use ICN Academy</small>
        </p>

    </center>
    <br />

    <p>ICN Academy was designed to be as easy and intuitive to use as possible. However, I understand that some guidance
    ...
    <div class="hdq_accordion">
        ...
        <div>
            ...
            <ul class="hdq_list">
                <li>To find the shortcode for a quiz, select ICN Academy -&gt; Quizzes in the left menu.</li>
                <li>You will now see a list of all of your quizzes in a table, with the shortcode listed. <span class="hdq_tooltip hdq_tooltip_question">?<span class="hdq_tooltip_content"><span>Example shortcode <code>[ICN quiz = "xxx"]</code></span></span></span></li>
                <li>Copy and paste the shortcode into any page or post you want to render that quiz!</li>
            </ul>
            <p>
                <strong>Gutenberg</strong>: ICN Academy is also fully Gutenberg compatible, and I even coded in a custom
                Gutenberg block to make adding quizzes easier than ever! If you are using Gutenberg, then you can add
                the ICN Academy block. A block will be added to your editor and will automatically populate a list of all of
    ...
    <div class="hdq_accordion">
        ...
        <div>
            <p>
                The latest and greatest version of ICN Academy makes creating custom question order easier than
                ever! When
    ...
    <div class="hdq_accordion">
        ...
        <div>
            <p>
                ...
                and love ICN Academy.</p>
            <p>So, loyal ICN Academy user, if you need help, please don't hesitate to leave us a message or question on the
                <a href="https://wordpress.org/support/plugin/hd-quiz" target="_blank">official WordPress ICN Academy
                    Support Forum</a>, or on our own <a href="http://harmonicdesign.ca/hd-quiz/" target="_blank">support
                    page at Harmonic Design</a>.
            </p>
        </div>
    </div>
</div>