...
<div id="main">
				...
				if (isset($term_meta) && $term_meta != null && $term_meta != "") {
					?>
						<div class = 'notice notice-success is-dismissible'>
							<p>Thank you for upgrading ICN Academy to v<?php echo HDQ_PLUGIN_VERSION;?>. <strong style = "font-weight: bold">This version requires updating your quiz and question data to be compatible with this version.</strong></p>
                ...
                foreach ($tax_terms as $tax_terms) {
                    ?>
							<div role = "button" class = "hdq_quiz_item hdq_quiz_term" data-name = "<?php echo $tax_terms->name; ?>" data-id = "<?php echo $tax_terms->term_id; ?>">
								...
								<code>[ICN quiz = "<?php echo $tax_terms->term_id; ?>"]</code>
							</div>
			<?php
                }
            }
	...
	<p>
		<strong>This latest update (v1.8) was a major change to how quiz and question data is saved and used by ICN Academy</strong>. Because of this, you may have issues converting your quizzes/questions over to the new format. If you have issues, please use the <a href = "<?php echo get_admin_url(null, "?page=hdq_tools_data_upgrade"); ?>">upgrade tool</a> <span class="hdq_tooltip">
    ?
...
<div class="hdq_highlight" id = "hd_patreon">
				...
				<p>
					ICN Academy is a 100% free plugin developed in my spare time, and as such, I get paid in nothing but good will and positive reviews. If you are enjoying ICN Academy and would like to show your support, please consider contributing to my <a href="https://www.patreon.com/harmonic_design" target="_blank">patreon page</a> to help continued development. Every little bit helps, and I am fuelled by ☕.
				</p>
			</div>	
